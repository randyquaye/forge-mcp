...
- **Descriptions are for AI.** Write tool descriptions as if explaining to a language model what the tool does, when to use it, what each parameter means, and what it returns.
